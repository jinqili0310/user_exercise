...
-- CreateIndex
CREATE UNIQUE INDEX "Save_userId_exerciseId_key" ON "Save"("userId", "exerciseId");
...
-- AddForeignKey
ALTER TABLE "Rating" ADD CONSTRAINT "Rating_exerciseId_fkey" FOREIGN KEY ("exerciseId") REFERENCES "Exercise"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
